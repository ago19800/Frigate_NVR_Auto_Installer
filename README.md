...
```bash
# Scarica / Download
wget https://raw.githubusercontent.com/TUO_UTENTE/frigate-lxc-installer/main/proxmox_setup.sh
...
wget https://raw.githubusercontent.com/TUO_UTENTE/frigate-lxc-installer/main/install_frigate.sh
